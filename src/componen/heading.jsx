                ...
                <div className="row overflow-hidden position-relative min-vh-100">
                    <div className="col-lg-6 text-center d-flex align-items-center justify-content-center">
                        <div className="header">
                            ...
                            <button className="btn profile-btn fw-semibold d-flex align-items-center justify-content-center">
                    ...
                    <spline-viewer className="spline-heading position-absolute" url="https://prod.spline.design/P-QAYCY1dj9Wo7aq/scene.splinecode"></spline-viewer>
                </div>
            </section>
        </>
    )
